    ...
    try {
      ...
      setError(
        err.message === 'Invalid login credentials'
          ...
          : err.message || 'Gagal masuk ke akun Anda.'
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-[#0b0f17] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden select-none">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center mb-6">
        ...
        <p className="mt-1 text-xs text-slate-400">
          Akses dashboard manajemen kas dan asisten AI Anda
        </p>
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="macos-window rounded-3xl overflow-hidden shadow-macos-window border border-white/15">
          ...
          <div className="px-5 py-3 border-b border-white/[0.08] bg-white/[0.02] flex items-center justify-between">
            ...
            <span className="text-[11px] font-semibold text-slate-400">Autentikasi Aman</span>
          </div>
          ...
          <div className="p-6 sm:p-7 space-y-5">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 rounded-xl text-xs font-semibold text-white flex items-center justify-center gap-2.5 transition-all active:scale-95 min-h-[40px]"
            >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-[10px] uppercase">
                <span className="bg-[#0e1424] px-2.5 text-slate-400 font-semibold">atau email</span>
              </div>
            </div>
